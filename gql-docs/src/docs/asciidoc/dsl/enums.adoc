...
include::{testMain2}/gql/dsl/EnumTypeSpec.groovy[tags=declaringEnum, indent=0]
----
...
include::{testMain2}/gql/dsl/EnumTypeSpec.groovy[tags=enumTypeInclusion, indent=0]
----
