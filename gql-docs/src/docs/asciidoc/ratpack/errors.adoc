...
[source, groovy]
----
include::{testMain2}/gql/dsl/SecurityInstrumentation.groovy[tags=instrumentation, indent=0]
----
...
[source, groovy]
----
include::{ratpack2}/src/test/groovy/gql/ratpack/SecurityChecker.groovy[indent=0]
----
