...
- `parseLiteral`: this function receives a query's argument used as literal (as oppose as using a query variable)
- `parseValue`: this function receives a query's argument used as a variable
...
The function passed as an argument to the `serialize` method will take whatever value is coming from the data fetcher
