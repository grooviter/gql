...
include::{testMain}/gql/DSLSpec.groovy[tags=standaloneFieldDefinition, indent=0]
----
...
include::{testMain}/gql/DSLSpec.groovy[tags=fieldStaticCompilation, indent=0]
----
...
include::{testMain}/gql/DSLSpec.groovy[tags=addField, indent=0]
----
